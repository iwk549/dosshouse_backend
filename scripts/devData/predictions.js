...
module.exports = [
  ...
  // Knockouts not yet played — playoff points will be 0 until results added
  {
    ...
    misc: { winner: "Brazil", thirdPlace: "Spain" },
  ...
  },
  {
    ...
    misc: { winner: "France", thirdPlace: "Argentina" },
    points: { group: { points: 0, correctPicks: 0, bonus: 0 }, playoff: { points: 0, correctPicks: 0 }, champion: { points: 0, correctPicks: 0 }, misc: { points: 0, correctPicks: 0 } },
    totalPoints: 0, totalPicks: 0, ranking: null, potentialPoints: { maximum: 0, realistic: 0 },
  },
  {
    // France first in A, Argentina wins the tournament
    userEmail: "test1@test.com",
    competitionCode: "devCupActive",
    name: "Spring Wildcards",
    groupPredictions: [
      { groupName: "A", teamOrder: ["France", "Brazil", "Germany"] },
      { groupName: "B", teamOrder: ["Argentina", "Spain", "Italy"] },
    ],
    playoffPredictions: [
      { matchNumber: 207, homeTeam: "France",    awayTeam: "Spain",      round: 1 },
      { matchNumber: 208, homeTeam: "Argentina", awayTeam: "Brazil",     round: 1 },
      { matchNumber: 209, homeTeam: "Argentina", awayTeam: "France",     round: 2 },
    ],
    misc: { winner: "Argentina", thirdPlace: "Brazil" },
    points: { group: { points: 0, correctPicks: 0, bonus: 0 }, playoff: { points: 0, correctPicks: 0 }, champion: { points: 0, correctPicks: 0 }, misc: { points: 0, correctPicks: 0 } },
    totalPoints: 0, totalPicks: 0, ranking: null, potentialPoints: { maximum: 0, realistic: 0 },
  },
  {
    // Spain first in B, Brazil wins
    userEmail: "test2@test.com",
    competitionCode: "devCupActive",
    name: "Spring Contrarian",
    groupPredictions: [
      { groupName: "A", teamOrder: ["Brazil", "Germany", "France"] },
      { groupName: "B", teamOrder: ["Spain", "Argentina", "Italy"] },
    ],
    playoffPredictions: [
      { matchNumber: 207, homeTeam: "Brazil",    awayTeam: "Argentina",  round: 1 },
      { matchNumber: 208, homeTeam: "Spain",     awayTeam: "Germany",    round: 1 },
      { matchNumber: 209, homeTeam: "Brazil",    awayTeam: "Spain",      round: 2 },
    ],
    misc: { winner: "Brazil", thirdPlace: "Germany" },
    points: { group: { points: 0, correctPicks: 0, bonus: 0 }, playoff: { points: 0, correctPicks: 0 }, champion: { points: 0, correctPicks: 0 }, misc: { points: 0, correctPicks: 0 } },
    totalPoints: 0, totalPicks: 0, ranking: null, potentialPoints: { maximum: 0, realistic: 0 },
  },
  // ── Dev Euro Cup (future) ────────────────────────────────────────────────
  ...
  {
    // Germany first in A, wins the tournament. 3rd place from ABCD qualifies.
    userEmail: "test3@test.com",
    competitionCode: "devCupFuture",
    name: "Euro Contenders",
    groupPredictions: [
      { groupName: "A", teamOrder: ["Germany",    "England",   "France",      "Spain"] },
      { groupName: "B", teamOrder: ["Brazil",     "Argentina", "Netherlands", "Italy"] },
      { groupName: "C", teamOrder: ["Portugal",   "Belgium",   "Croatia",     "Denmark"] },
      { groupName: "D", teamOrder: ["Japan",      "Morocco",   "South Korea", "Australia"] },
      { groupName: "E", teamOrder: ["Colombia",   "Uruguay",   "Sweden",      "Senegal"] },
      { groupName: "F", teamOrder: ["Poland",     "Switzerland","Serbia",     "Scotland"] },
      { groupName: "devCup3rdPlace", teamOrder: ["A: France", "B: Netherlands", "C: Croatia", "D: South Korea", "E: Sweden", "F: Serbia"] },
    ],
    playoffPredictions: [
      { matchNumber: 137, homeTeam: "Germany",   awayTeam: "France",       round: 1 },
      { matchNumber: 138, homeTeam: "Brazil",    awayTeam: "Netherlands",  round: 1 },
      { matchNumber: 139, homeTeam: "Colombia",  awayTeam: "Switzerland",  round: 1 },
      { matchNumber: 140, homeTeam: "Poland",    awayTeam: "Uruguay",      round: 1 },
      { matchNumber: 141, homeTeam: "Portugal",  awayTeam: "Morocco",      round: 1 },
      { matchNumber: 142, homeTeam: "Japan",     awayTeam: "Belgium",      round: 1 },
      { matchNumber: 143, homeTeam: "Croatia",   awayTeam: "England",      round: 1 },
      { matchNumber: 144, homeTeam: "South Korea", awayTeam: "Argentina",  round: 1 },
      { matchNumber: 145, homeTeam: "Germany",   awayTeam: "Brazil",       round: 2 },
      { matchNumber: 146, homeTeam: "Colombia",  awayTeam: "Poland",       round: 2 },
      { matchNumber: 147, homeTeam: "Portugal",  awayTeam: "Japan",        round: 2 },
      { matchNumber: 148, homeTeam: "Argentina", awayTeam: "Croatia",      round: 2 },
      { matchNumber: 149, homeTeam: "Germany",   awayTeam: "Colombia",     round: 3 },
      { matchNumber: 150, homeTeam: "Portugal",  awayTeam: "Argentina",    round: 3 },
      { matchNumber: 151, homeTeam: "Germany",   awayTeam: "Portugal",     round: 4 },
    ],
    misc: { winner: "Germany", topScorer: "Germany" },
    points: { group: { points: 0, correctPicks: 0, bonus: 0 }, playoff: { points: 0, correctPicks: 0 }, champion: { points: 0, correctPicks: 0 }, misc: { points: 0, correctPicks: 0 } },
    totalPoints: 0, totalPicks: 0, ranking: null, potentialPoints: { maximum: 0, realistic: 0 },
  },
  {
    // France first in A, Argentina first in B, Argentina wins. 3rd place from ABCD qualifies.
    ...
    groupPredictions: [
      { groupName: "A", teamOrder: ["France",     "England",   "Germany",     "Spain"] },
      { groupName: "B", teamOrder: ["Argentina",  "Brazil",    "Italy",       "Netherlands"] },
      { groupName: "C", teamOrder: ["Belgium",    "Portugal",  "Denmark",     "Croatia"] },
      { groupName: "D", teamOrder: ["Morocco",    "Japan",     "Australia",   "South Korea"] },
      { groupName: "E", teamOrder: ["Colombia",   "Uruguay",   "Senegal",     "Sweden"] },
      { groupName: "F", teamOrder: ["Switzerland","Poland",    "Scotland",    "Serbia"] },
      { groupName: "devCup3rdPlace", teamOrder: ["A: Germany", "B: Italy", "C: Denmark", "D: Australia", "E: Senegal", "F: Scotland"] },
    ],
    playoffPredictions: [
      { matchNumber: 137, homeTeam: "France",     awayTeam: "Germany",      round: 1 },
      { matchNumber: 138, homeTeam: "Argentina",  awayTeam: "Italy",        round: 1 },
      { matchNumber: 139, homeTeam: "Colombia",   awayTeam: "Poland",       round: 1 },
      { matchNumber: 140, homeTeam: "Switzerland",awayTeam: "Uruguay",      round: 1 },
      { matchNumber: 141, homeTeam: "Belgium",    awayTeam: "Japan",        round: 1 },
      { matchNumber: 142, homeTeam: "Morocco",    awayTeam: "Portugal",     round: 1 },
      { matchNumber: 143, homeTeam: "Denmark",    awayTeam: "England",      round: 1 },
      { matchNumber: 144, homeTeam: "Australia",  awayTeam: "Brazil",       round: 1 },
      { matchNumber: 145, homeTeam: "France",     awayTeam: "Argentina",    round: 2 },
      { matchNumber: 146, homeTeam: "Colombia",   awayTeam: "Switzerland",  round: 2 },
      { matchNumber: 147, homeTeam: "Belgium",    awayTeam: "Morocco",      round: 2 },
      { matchNumber: 148, homeTeam: "Denmark",    awayTeam: "Brazil",       round: 2 },
      { matchNumber: 149, homeTeam: "Argentina",  awayTeam: "Colombia",     round: 3 },
      { matchNumber: 150, homeTeam: "Belgium",    awayTeam: "Brazil",       round: 3 },
      { matchNumber: 151, homeTeam: "Argentina",  awayTeam: "Belgium",      round: 4 },
    ],
    misc: { winner: "Argentina", topScorer: "Argentina" },
    points: { group: { points: 0, correctPicks: 0, bonus: 0 }, playoff: { points: 0, correctPicks: 0 }, champion: { points: 0, correctPicks: 0 }, misc: { points: 0, correctPicks: 0 } },
    totalPoints: 0, totalPicks: 0, ranking: null, potentialPoints: { maximum: 0, realistic: 0 },
  },
  {
    // Spain first in A, Portugal wins. 3rd place from ABCD qualifies.
    userEmail: "test5@test.com",
    competitionCode: "devCupFuture",
    name: "Euro Romantics",
    groupPredictions: [
      { groupName: "A", teamOrder: ["Spain",      "France",    "England",     "Germany"] },
      { groupName: "B", teamOrder: ["Brazil",     "Netherlands","Argentina",  "Italy"] },
      { groupName: "C", teamOrder: ["Portugal",   "Denmark",   "Belgium",     "Croatia"] },
      { groupName: "D", teamOrder: ["Morocco",    "South Korea","Japan",      "Australia"] },
      { groupName: "E", teamOrder: ["Uruguay",    "Colombia",  "Sweden",      "Senegal"] },
      { groupName: "F", teamOrder: ["Poland",     "Serbia",    "Switzerland", "Scotland"] },
      { groupName: "devCup3rdPlace", teamOrder: ["A: England", "B: Argentina", "C: Belgium", "D: Japan", "E: Sweden", "F: Switzerland"] },
    ],
    playoffPredictions: [
      { matchNumber: 137, homeTeam: "Spain",      awayTeam: "England",      round: 1 },
      { matchNumber: 138, homeTeam: "Brazil",     awayTeam: "Argentina",    round: 1 },
      { matchNumber: 139, homeTeam: "Uruguay",    awayTeam: "Serbia",       round: 1 },
      { matchNumber: 140, homeTeam: "Poland",     awayTeam: "Colombia",     round: 1 },
      { matchNumber: 141, homeTeam: "Portugal",   awayTeam: "South Korea",  round: 1 },
      { matchNumber: 142, homeTeam: "Morocco",    awayTeam: "Denmark",      round: 1 },
      { matchNumber: 143, homeTeam: "Belgium",    awayTeam: "France",       round: 1 },
      { matchNumber: 144, homeTeam: "Japan",      awayTeam: "Netherlands",  round: 1 },
      { matchNumber: 145, homeTeam: "Spain",      awayTeam: "Brazil",       round: 2 },
      { matchNumber: 146, homeTeam: "Uruguay",    awayTeam: "Poland",       round: 2 },
      { matchNumber: 147, homeTeam: "Portugal",   awayTeam: "Morocco",      round: 2 },
      { matchNumber: 148, homeTeam: "France",     awayTeam: "Netherlands",  round: 2 },
      { matchNumber: 149, homeTeam: "Spain",      awayTeam: "Uruguay",      round: 3 },
      { matchNumber: 150, homeTeam: "Portugal",   awayTeam: "France",       round: 3 },
      { matchNumber: 151, homeTeam: "Spain",      awayTeam: "Portugal",     round: 4 },
    ],
    misc: { winner: "Portugal", topScorer: "Portugal" },
    points: { group: { points: 0, correctPicks: 0, bonus: 0 }, playoff: { points: 0, correctPicks: 0 }, champion: { points: 0, correctPicks: 0 }, misc: { points: 0, correctPicks: 0 } },
    totalPoints: 0, totalPicks: 0, ranking: null, potentialPoints: { maximum: 0, realistic: 0 },
  },
  {
    // France first in A, France wins. 3rd place from ABCD qualifies.
    userEmail: "test6@test.com",
    competitionCode: "devCupFuture",
    name: "Euro Classic",
    groupPredictions: [
      { groupName: "A", teamOrder: ["France",     "Germany",   "Spain",       "England"] },
      { groupName: "B", teamOrder: ["Brazil",     "Argentina", "Netherlands", "Italy"] },
      { groupName: "C", teamOrder: ["Portugal",   "Belgium",   "Croatia",     "Denmark"] },
      { groupName: "D", teamOrder: ["Japan",      "Morocco",   "South Korea", "Australia"] },
      { groupName: "E", teamOrder: ["Colombia",   "Sweden",    "Uruguay",     "Senegal"] },
      { groupName: "F", teamOrder: ["Poland",     "Switzerland","Serbia",     "Scotland"] },
      { groupName: "devCup3rdPlace", teamOrder: ["A: Spain", "B: Netherlands", "C: Croatia", "D: South Korea", "E: Uruguay", "F: Serbia"] },
    ],
    playoffPredictions: [
      { matchNumber: 137, homeTeam: "France",     awayTeam: "Spain",        round: 1 },
      { matchNumber: 138, homeTeam: "Brazil",     awayTeam: "Netherlands",  round: 1 },
      { matchNumber: 139, homeTeam: "Colombia",   awayTeam: "Switzerland",  round: 1 },
      { matchNumber: 140, homeTeam: "Poland",     awayTeam: "Sweden",       round: 1 },
      { matchNumber: 141, homeTeam: "Portugal",   awayTeam: "Morocco",      round: 1 },
      { matchNumber: 142, homeTeam: "Japan",      awayTeam: "Belgium",      round: 1 },
      { matchNumber: 143, homeTeam: "Croatia",    awayTeam: "Germany",      round: 1 },
      { matchNumber: 144, homeTeam: "South Korea",awayTeam: "Argentina",    round: 1 },
      { matchNumber: 145, homeTeam: "France",     awayTeam: "Brazil",       round: 2 },
      { matchNumber: 146, homeTeam: "Colombia",   awayTeam: "Poland",       round: 2 },
      { matchNumber: 147, homeTeam: "Portugal",   awayTeam: "Japan",        round: 2 },
      { matchNumber: 148, homeTeam: "Germany",    awayTeam: "Argentina",    round: 2 },
      { matchNumber: 149, homeTeam: "France",     awayTeam: "Colombia",     round: 3 },
      { matchNumber: 150, homeTeam: "Portugal",   awayTeam: "Germany",      round: 3 },
      { matchNumber: 151, homeTeam: "France",     awayTeam: "Portugal",     round: 4 },
    ],
    misc: { winner: "France", topScorer: "France" },
    points: { group: { points: 0, correctPicks: 0, bonus: 0 }, playoff: { points: 0, correctPicks: 0 }, champion: { points: 0, correctPicks: 0 }, misc: { points: 0, correctPicks: 0 } },
    totalPoints: 0, totalPicks: 0, ranking: null, potentialPoints: { maximum: 0, realistic: 0 },
  ...
  {
    // England first in A, Brazil wins. 3rd place from ABCD qualifies.
    userEmail: "test7@test.com",
    competitionCode: "devCupFuture",
    name: "Euro Hopeful",
    groupPredictions: [
      { groupName: "A", teamOrder: ["England",    "Spain",     "France",      "Germany"] },
      { groupName: "B", teamOrder: ["Brazil",     "Argentina", "Netherlands", "Italy"] },
      { groupName: "C", teamOrder: ["Portugal",   "Croatia",   "Belgium",     "Denmark"] },
      { groupName: "D", teamOrder: ["Japan",      "Australia", "Morocco",     "South Korea"] },
      { groupName: "E", teamOrder: ["Uruguay",    "Senegal",   "Colombia",    "Sweden"] },
      { groupName: "F", teamOrder: ["Switzerland","Poland",    "Scotland",    "Serbia"] },
      { groupName: "devCup3rdPlace", teamOrder: ["A: France", "B: Netherlands", "C: Belgium", "D: Morocco", "E: Colombia", "F: Scotland"] },
    ],
    playoffPredictions: [
      { matchNumber: 137, homeTeam: "England",    awayTeam: "France",       round: 1 },
      { matchNumber: 138, homeTeam: "Brazil",     awayTeam: "Netherlands",  round: 1 },
      { matchNumber: 139, homeTeam: "Uruguay",    awayTeam: "Poland",       round: 1 },
      { matchNumber: 140, homeTeam: "Switzerland",awayTeam: "Senegal",      round: 1 },
      { matchNumber: 141, homeTeam: "Portugal",   awayTeam: "Australia",    round: 1 },
      { matchNumber: 142, homeTeam: "Japan",      awayTeam: "Croatia",      round: 1 },
      { matchNumber: 143, homeTeam: "Belgium",    awayTeam: "Spain",        round: 1 },
      { matchNumber: 144, homeTeam: "Morocco",    awayTeam: "Argentina",    round: 1 },
      { matchNumber: 145, homeTeam: "England",    awayTeam: "Brazil",       round: 2 },
      { matchNumber: 146, homeTeam: "Uruguay",    awayTeam: "Switzerland",  round: 2 },
      { matchNumber: 147, homeTeam: "Portugal",   awayTeam: "Japan",        round: 2 },
      { matchNumber: 148, homeTeam: "Spain",      awayTeam: "Argentina",    round: 2 },
      { matchNumber: 149, homeTeam: "Brazil",     awayTeam: "Uruguay",      round: 3 },
      { matchNumber: 150, homeTeam: "Portugal",   awayTeam: "Argentina",    round: 3 },
      { matchNumber: 151, homeTeam: "Brazil",     awayTeam: "Portugal",     round: 4 },
    ],
    misc: { winner: "Brazil", topScorer: "Brazil" },
    points: { group: { points: 0, correctPicks: 0, bonus: 0 }, playoff: { points: 0, correctPicks: 0 }, champion: { points: 0, correctPicks: 0 }, misc: { points: 0, correctPicks: 0 } },
    totalPoints: 0, totalPicks: 0, ranking: null, potentialPoints: { maximum: 0, realistic: 0 },
  },
  {
    // Spain first in A, Argentina first in B, Spain wins. 3rd place from ABCD qualifies.
    userEmail: "test8@test.com",
    competitionCode: "devCupFuture",
    name: "Euro Pragmatist",
    groupPredictions: [
      { groupName: "A", teamOrder: ["Spain",      "England",   "Germany",     "France"] },
      { groupName: "B", teamOrder: ["Argentina",  "Netherlands","Brazil",     "Italy"] },
      { groupName: "C", teamOrder: ["Belgium",    "Portugal",  "Denmark",     "Croatia"] },
      { groupName: "D", teamOrder: ["Morocco",    "Japan",     "South Korea", "Australia"] },
      { groupName: "E", teamOrder: ["Colombia",   "Uruguay",   "Sweden",      "Senegal"] },
      { groupName: "F", teamOrder: ["Poland",     "Serbia",    "Switzerland", "Scotland"] },
      { groupName: "devCup3rdPlace", teamOrder: ["A: Germany", "B: Brazil", "C: Denmark", "D: South Korea", "E: Sweden", "F: Switzerland"] },
    ],
    playoffPredictions: [
      { matchNumber: 137, homeTeam: "Spain",      awayTeam: "Germany",      round: 1 },
      { matchNumber: 138, homeTeam: "Argentina",  awayTeam: "Brazil",       round: 1 },
      { matchNumber: 139, homeTeam: "Colombia",   awayTeam: "Serbia",       round: 1 },
      { matchNumber: 140, homeTeam: "Poland",     awayTeam: "Uruguay",      round: 1 },
      { matchNumber: 141, homeTeam: "Belgium",    awayTeam: "Japan",        round: 1 },
      { matchNumber: 142, homeTeam: "Morocco",    awayTeam: "Portugal",     round: 1 },
      { matchNumber: 143, homeTeam: "Denmark",    awayTeam: "England",      round: 1 },
      { matchNumber: 144, homeTeam: "South Korea",awayTeam: "Netherlands",  round: 1 },
      { matchNumber: 145, homeTeam: "Spain",      awayTeam: "Argentina",    round: 2 },
      { matchNumber: 146, homeTeam: "Colombia",   awayTeam: "Poland",       round: 2 },
      { matchNumber: 147, homeTeam: "Belgium",    awayTeam: "Morocco",      round: 2 },
      { matchNumber: 148, homeTeam: "England",    awayTeam: "Netherlands",  round: 2 },
      { matchNumber: 149, homeTeam: "Spain",      awayTeam: "Colombia",     round: 3 },
      { matchNumber: 150, homeTeam: "Belgium",    awayTeam: "England",      round: 3 },
      { matchNumber: 151, homeTeam: "Spain",      awayTeam: "Belgium",      round: 4 },
    ],
    misc: { winner: "Spain", topScorer: "Spain" },
    points: { group: { points: 0, correctPicks: 0, bonus: 0 }, playoff: { points: 0, correctPicks: 0 }, champion: { points: 0, correctPicks: 0 }, misc: { points: 0, correctPicks: 0 } },
    totalPoints: 0, totalPicks: 0, ranking: null, potentialPoints: { maximum: 0, realistic: 0 },
  },
];
